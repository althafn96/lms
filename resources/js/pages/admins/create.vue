            ...
            <form @submit.prevent="handleSubmit" ref="form" class="form fv-plugins-bootstrap5 fv-plugins-framework d-flex flex-column flex-lg-row">
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the admin image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <button @click.prevent="router.go(-1)" id="admin_create_cancel" class="btn btn-light me-5">Cancel</button>
                        <!--end::Button-->
                        <!--begin::Button-->
...
import addAdmin from '@/graphql/mutations/users/addAdmin.gql'
...
const { mutate: addAdminMutation, onDone, onError  } = useMutation(addAdmin)
...
const handleSubmit = () => {
    validator.validate().then(async function (status) {
        if (status == 'Valid') {
            ...
            try {
                const res = await addAdminMutation(
                    {...formData},
                    {
                        context: {
                            hasUpload: true
