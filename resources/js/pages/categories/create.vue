...
import addCategory from '@/graphql/mutations/courses/addCategory.gql'
...
const { mutate: addCategoryMutation, onDone, onError  } = useMutation(addCategory)
