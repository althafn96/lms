    ...
    <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
        ...
        <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
            ...
            <router-link to="/dashboard">
                <!-- <img alt="Logo" src="/media/logos/logo-demo3-default.svg" class="h-20px logo" /> -->
                <div style="color: #000; font-weight: 800; font-size: 20px">.L&L Solution</div>
            </router-link>
            <!--end::Logo-->
        </div>
        <!--end::Brand-->
                ...
                <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <router-link class="menu-link" to="/admins">
                            ...
                            <div class="menu-item">
                                <router-link class="menu-link" to="/instructors">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <router-link class="menu-link" to="/students">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <router-link class="menu-link" to="/categories">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Course Categories</span>
                                </router-link>
                            </div>
                            <div class="menu-item">
                                <router-link class="menu-link" to="/courses">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <router-link class="menu-link" to="/batches">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <router-link class="menu-link" to="/enrollments">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="symbol symbol-circle symbol-40px">
                        <img :src="auth.user.loggable.display_picture" alt="photo" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::User info-->
                    <div class="ms-2">
                        ...
                        <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder lh-1">
                            {{ auth.user.loggable.full_name }}
                        </a>
                        <!--end::Name-->
                        <!--begin::Major-->
                        <span class="text-muted fw-bold d-block fs-7 lh-1">{{ auth.user.loggable.__typename }}</span>
                        <!--end::Major-->
                    </div>
                    <!--end::User info-->
                </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">{{ auth.user.loggable.full_name }}</div>
...
import Logout from '@/graphql/mutations/auth/Logout.gql'
...
const logout = async() => {
    const res = await auth.logout(logoutMutation)
