    ...
    <div id="kt_header" class="header">
        ...
        <div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">{{ props.title }}</h1>
                <!--end::Heading-->

                <!-- begin::Breadcrumbs -->
                <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
                    <li v-for="breadcrumb in props.breadcrumbs" class="breadcrumb-item text-muted">

                        <router-link v-if="breadcrumb.link != ''" :to="breadcrumb.link" class="text-muted">{{breadcrumb.title}}</router-link>
                        <span v-else class="text-muted">{{breadcrumb.title}}</span>
                    </li>
                </ul>
                <!-- begin::Breadcrumbs -->
            </div>
            ...
            <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                ...
                <router-link to="/dashboard">
                    ...
                    <div style="color: #000; font-weight: 800; font-size: 16px">.L&L Solution</div>
                </router-link>
                <!--end::Logo-->
            </div>
            <!--end::Wrapper-->
            ...
            <div class="d-flex align-items-center flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-3 ms-lg-4">
                    ...
                    <a class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary w-40px h-40px" href="../../demo3/dist/documentation/getting-started/dark-mode.html">
